...
<form method="GET" action="mail/sendmail.php">
<table>
<caption></caption>
<tr>
<td>email : </td>
...
<tr>
<td>Sujet</td>
<td><input type="text" name="sujet" class="form-control form-control-user" ></td>
</tr>
<tr>
<td>Text</td>
<td><input type="text" name="text" class="form-control form-control-user" ></td>
</tr>
<tr>
<td></td>
<td><button type="submit" class="btn btn-primary btn-icon-split btn-lg" name="modifier" > envoyer </button></td>
</tr>
<tr>
<td></td>
<td></td>

    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Gestions Categorie</h1>
                ...
                <button id="positionajouter" class="ajouter" href="#modalSubscriptionForm"
                  data-toggle="modal">Ajouter</button>
                   -->
                    ...
                    <form name="f" method="POST" action="ajoutercategorie.php">
                          <table>
                            <tr>
                              <td>
                                <input type="text" id="nomprenom" class="form-control form-control-user" name="idC" required >
                            ...
                            <tr>
                              <td>
                                <input type="text" id="email"  name="nomC" class="form-control form-control-user" >
                            ...
                            <tr>
                                <td>
                                    <label>Nom de categorie</label> </td>
  
                            </tr>
                            <tr>
                              <td>
                                <input type="text" id="age"  name="famille" class="form-control form-control-user" >
                            ...
                            <tr>
                                <td>
                                    <label>Famille</label></td>
  
                            </tr>
                            
                            <tr>
                              <td>
                                <input type="submit" name="ajouter" value="ajouter"  class="ajouter" onclick="tester()" , enctype="multipart/form-data">
                              </td>
                            </tr>

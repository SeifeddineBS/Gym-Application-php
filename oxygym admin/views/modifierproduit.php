...
<tr>
<td>Id</td>
<td><input type="text" name="idP" class="form-control form-control-user" value="<?PHP echo $idP ?>"></td>
</tr>
<tr>
<td>Nom de produit</td>
<td><input type="text" name="nomP" class="form-control form-control-user" value="<?PHP echo $nomP ?>"></td>
</tr>
<tr>
<td>Quantite</td>
<td><input type="text" name="quantiteP" class="form-control form-control-user" value="<?PHP echo $quantiteP ?>"></td>
</tr>
<tr>
<td>description</td>
<td><input type="text" name="description" class="form-control form-control-user" value="<?PHP echo $description ?>"></td>
</tr>
<tr>
<td>prix</td>
<td><input type="text" name="prix" class="form-control form-control-user" value="<?PHP echo $prix ?>"></td>
</tr>
<tr>
  <td>image</td>
  <td><input  type="file" name="image" class="form-control form-control-user" ></td>
</tr>
<tr>
<td></td>
<td><button type="submit" class="btn btn-primary btn-icon-split btn-lg" name="modifier" > MODIFIER </button></td>
</tr>
<tr>
<td></td>
...
if (isset($_POST['modifier'])){
  ...
  echo $_POST['idP'];
echo'<script>location.replace("Gestions Produits.php")</script>';
}
?>

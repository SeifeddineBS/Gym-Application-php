                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                               ...
                               <form class="forms-sample" action="mail/sendmail.php" method="GET">
                               	<h3>TO : <?php echo $row['email'];  ?></h3>
                               	<input type="text" name="email" hidden="true" value="<?php echo $row['email'];  ?>">
                      <div class="form-group">
                        <label for="exampleInputUsername1">sujet</label>
                        <input type="text" class="form-control" id="exampleInputUsername1"  name="sujet" >
                      </div>
                      <div class="form-group">

...
<section id="main-container" class="portfolio portfolio-box">
	<div class="container">
		...
		<div class="row">
                    ...
                    $listeproduits=$produit1C->afficherproduitcat($_GET["idc"]);
  ...
  ?>
			...
			<div class="col-md-3 col-sm-6 wow fadeInUp" data-wow-delay=".5s">
				<div class="plan text-center">
					...
					<p class="plan-price"><sup class="currency"><img class="" src="images\portfolio\<?php echo $row['image'];?>" style="width: 200px; height:200px;"></p>
